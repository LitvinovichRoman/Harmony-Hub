...
final class TabBarPresenter: TabBarPresenterProtocol {
    ...
    func createTabItems() -> [TabItem] {
        tabItems = [
            ...
            TabItem(index: 1, tabText: Resources.Strings.TabBar.meditation, tabImage: Resources.Icons.TabBar.meditation),
    ...
    func setupControllers() {
        ...
        let awarenessView = UINavigationController(rootViewController: Builder.getAwarenessView())
        ...
        let controllers = [mainView, awarenessView, thoughtsView, profileView]
        controllers.forEach {
